...
;(function ( $, window, document, undefined ) {
    ...
    var pluginName = "isLoading",
        defaults = {
            ...
            'tpl': '<span class="isloading-wrapper %wrapper%"><div id="loading-div"><img src="/images/ajax_modal_loading.gif" class="%class%"><p>%text%</p></div></span>',    // loader base Tag
    ...
    Plugin.prototype = {
        ...
        show: function() {
            ...
            switch( this.options.position ) {
                ...
                case "overlay":
                    if( $( this.element ).is( "body") ) {
                        $( "body" ).prepend( '<div class="isloading-overlay" style="position:fixed; left:0; top:0; right:0; bottom:0; z-index: 100052; background: rgba(0,0,0,0.5);"/>' );
                    }
                    else {
